  ...
  return (
    <section className="py-12 px-4 mb-16 sm:py-16 sm:px-6 sm:mb-24 lg:px-16 lg:py-20 lg:mb-40">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 sm:gap-12 lg:gap-16 items-center">
        ...
        >
          {/* Text */}
          <motion.div variants={item} className="text-white space-y-4 sm:space-y-6 w-full max-w-2xl lg:max-w-none">
        ...
        >
          <form className="space-y-5 sm:space-y-6 md:space-y-8 text-white w-full text-left">
            ...
            <div className="space-y-3 pt-2">
              <label className="text-xs sm:text-sm text-gray-400 font-medium ml-1">Budget Range</label>
            ...
            <div className="flex flex-col gap-2 pt-2">
              <label className="text-xs sm:text-sm text-gray-400 font-medium ml-1">Project Detail</label>
              <motion.textarea
                rows={4}
                whileFocus={{
                  scale: 1.01,
...
function Input({ label, type = "text" }: { label: string; type?: string }) {
  return (
    <div className="flex flex-col gap-1.5 sm:gap-2">
      <label className="text-xs sm:text-sm text-gray-400 font-medium ml-1">{label}</label>
      <motion.input
        type={type}
        whileFocus={{
          scale: 1.01,
