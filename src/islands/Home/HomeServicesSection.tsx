            ...
            {services.map((service, index) => (
              <SwiperSlide key={service.id} className="h-auto">
                ...
                >
                  ...
                  <div className="relative h-full bg-[#0f172a]/80 backdrop-blur-sm rounded-3xl border border-white/5 overflow-hidden z-10 transition-all duration-500 ease-out lg:group-hover:-translate-y-2 lg:group-hover:rotate-2 origin-bottom-right">
