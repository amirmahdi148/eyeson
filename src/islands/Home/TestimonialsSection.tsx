...
export default function TestimonialsSection() {
  const [stars, setStars] = useState<Array<{ top: string; left: string; size: number; delay: number }>>([]);
  ...
  const testimonials = [
    {
      ...
      avatar: '/home/Hero/clients/1.jpg',
    ...
    },
    {
      ...
      avatar: '/home/Hero/clients/2.jpg',
      text: 'We needed a quick turnaround, and they delivered exceptional quality ahead of schedule. Truly professional team.',
      stars: 4,
    },
    {
      ...
      avatar: '/home/Hero/clients/3.jpg',
      text: 'We needed a quick turnaround, and they delivered exceptional quality ahead of schedule. Truly professional team.',
      stars: 5,
    },
    {
      ...
      name: 'James K.',
      role: 'CEO, StartupX',
      avatar: '/home/Hero/clients/4.jpg',
    ...
    <section className="relative py-24 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 max-w-7xl">
        ...
        >
          ...
          >
            What our <span className="text-[#21AFAF] relative inline-block">
              clients
              <motion.div 
                initial={{ width: 0 }} 
        ...
        >
          ...
          {/* ========================================== */}
          <motion.button 
            whileHover={{ scale: 1.15, backgroundColor: "#1e293b", borderColor: "rgba(33, 175, 175, 0.5)" }}
            whileTap={{ scale: 0.9 }}
