      ...
      <div className="mx-auto max-w-6xl">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-5 text-sm leading-7 text-white/65 md:text-base">
            From concept to final delivery, our streamlined process ensures every
            2D and 3D animation is crafted with precision, clarity, and maximum
            visual impact.
          </p>
        </div>
