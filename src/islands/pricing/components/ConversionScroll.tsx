...
export const ConversionScroll = () => {
    ...
    return (
        <section ref={sectionRef} className="relative z-10 mx-auto hidden w-full max-w-[920px] px-4 pb-24 pt-5 lg:block">
                    ...
                    {STEPS.map((step, index) => {
                        ...
                        return (
                            <div key={step.id} className="grid grid-cols-1 items-center gap-5 lg:grid-cols-[1fr_90px_1fr]">
                                ...
                                >
                                    <h3 className="text-[#1FC5C8] text-xl font-black">{step.title}</h3>
