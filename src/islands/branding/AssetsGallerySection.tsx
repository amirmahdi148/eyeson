...
export const AssetsGallerySection = () => {
  ...
  const card = "bg-[#0A1A24] border border-[#14313B] rounded-[24px] overflow-hidden shadow-lg";
  ...
  return (
    <section className="w-full py-12 px-4 sm:py-16 md:px-8 lg:py-20 lg:px-16 font-sans">
      ...
      >
        ...
        >
          <h3 className="text-xl font-bold text-white mb-2 sm:text-2xl">Logo design</h3>
          <p className="text-gray-400 text-xs leading-relaxed font-light mb-4 sm:text-sm sm:mb-5">
            ...
            audience. Clean, versatile, and built to scale across every platform.
          </p>
        ...
        >
          ...
          <div className="flex-1">
            <h3 className="text-lg font-bold text-white mb-2 sm:text-xl">Branded GIFs</h3>
