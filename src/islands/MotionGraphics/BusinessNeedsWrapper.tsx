...
export const BusinessNeedsWrapper = () => {
    const cards = [
        {
            ...
            description: "Motion graphics give your brand a visual identity that feels modern, unique, and instantly recognizable.",
    ...
    return (
        <BusinessNeedsSection cards={cards} rightSection={<AnimatedSVG /> } />
    )
}